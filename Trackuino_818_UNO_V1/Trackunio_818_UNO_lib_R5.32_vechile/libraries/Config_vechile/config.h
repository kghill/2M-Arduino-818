...
// Define symbols
#define APRS_TABLE  "/"    // Primary Table '/' , Alternate Table '\' 
#define APRS_SYMBOL ">"  // O=balloon, >=Car, -=QTH, _= Weather
...
// 00:02:30, etc.
#define APRS_SLOT     43     // seconds. -1 disables slotted transmissions
...
// Also baud rate of BME280
#define GPS_BAUDRATE  9600

// -------------------------------------------------------------------------
// Solar Power Board
// -------------------------------------------------------------------------
#define vinSwitch 8 // High turns power on Vin pin
...
// Define DRA818 pins
#define HL       9  // High/Low power
#define PTT_PIN  10
#define PD       11 // Power Down pin. This need to start low, then be set high before programming. 
#define DRA_RXD  12  // The Arduino IO line (RX) that is connected to the DRA818's TXD pin.
#define DRA_TXD  13  // The Arduino IO line (TX) connected to the DRA818's RXD pin.
...
#define VMETER_R2       2700
#define vincal          80    // difference times 10


// Resistors divider for the solar panel voltage meter (ohms)
#define SPVMETER_R1     10000
#define SPVMETER_R2     10000
#define spvincal        80    // difference times 10


// Resistors divider for the solar panel voltage meter (ohms)
#define BVMETER_R1       10000
#define BVMETER_R2       20000
#define bvincal          40   // difference times 10

// Voltage meter analog pin
#define SPVMETER_PIN    0
// Voltage meter analog pin
#define BVMETER_PIN     1
// Voltage meter analog pin
#define VMETER_PIN      2
// --------------------------------------------------------------------------
